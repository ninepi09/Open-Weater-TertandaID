//package com.tertandaid.openweather.Model.db;
//
...
//
//    @Override
//    public void bindView(@NonNull MultipleDaysWeather item, @NonNull ThreeDayList<Object> payloads) {
